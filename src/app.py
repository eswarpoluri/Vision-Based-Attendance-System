...
from src.com_in_collect_trainingdata.get_faces_from_camera import TrainingDataCollector
from src.com_in_ai_face_embedding.faces_embedding import GenerateFaceEmbedding
from src.com_in_ai_predictor.facePredictor import FacePredictor
from src.com_in_ai_training.train_softmax import TrainFaceRecogModel
...
class RegistrationModule:
    def __init__(self, logFileName):
        ...
        link2 = tk.Label(self.window, text="Copyright©2020", fg="blue", )
